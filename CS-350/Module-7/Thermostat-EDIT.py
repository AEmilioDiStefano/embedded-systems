...
#------------------------------------------------------------------
#    2          Added code for full smart-thermostat functionality
#------------------------------------------------------------------
...
class TemperatureMachine(StateMachine):
    ...
    def processTempStateButton(self):
        ...
        ##
        ## TODO: Change the state of the thermostat.
        self.send("cycle")
    ...
    def processTempIncButton(self):
        ...
        ##
        ## TODO: Update the setPoint of the thermostat and the status 
        ## lights within the circuit.
        setPoint = setPoint + 1
        updateLights()
    ...
    def updateLights(self):
        ...
        if(thSensor.temperature > setPoint):
            on_exit_heat()
            heat.to(cool)
            on_enter_cool()
        elif(tSensor.temperature < setPoint):
            on_exit_cool()
            cool.to(heat)
            on_enter_cool()
    ...
    def setupSerialOutput(self):
        ##
        ## TODO: Create the string assigned to the 'output' variable 
        ## that will provide the single line of text that will be sent 
        ## to the TemperatureServer over the Serial Port (UART).
        output = "State: " + self.current_state.id  + ", \nCurrent Temp:" + getFahrenheit() + ", \nTarget Temp: " + setpoint
